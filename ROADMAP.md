...
3. **Release process**: hosted repository, `[project.urls]`, the CI workflow already sketched in
   the README, `dataset-doctor-audit` on PyPI, signed tags. Nothing here until (1).
